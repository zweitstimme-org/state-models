...
**Fehlende Parteien in Umfragen:** Institute weisen Parteien unterhalb von etwa 3 % häufig nicht einzeln aus (sie fallen dort in Sonstige). Für die latenten Umfragewerte halten wir solche Parteien für **90 Tage** nach ihrem letzten ausgewiesenen Wert bei **2 %**; danach entfallen sie, bis wieder ein echter Umfragewert vorliegt. Das Paper kannte keine solche Imputation auf Umfrage-Ebene (dort wurden nur fehlende Lead-Prädiktoren per Regression imputiert).
